...
// ===== DEBUGGING: Temporarily disable POST request check =====
// Uncomment the next lines to re-enable the check later
/*
...
// Check if expected POST variables exist
...
// Insert password exactly as input (no hashing), and set status = 0 (awaiting admin approval)
